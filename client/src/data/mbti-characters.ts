...
export const characters: Record<string, Character> = {
  ...
  ENFP: {
    ...
    mbtiType: "ENFP",
    title: "열정적 영감가",
    description: "당신은 사샤 블라우스와 같은 성격입니다. 열정적이고 창의적이며 새로운 가능성을 탐구하는 사람입니다.",
  ...
  ESTJ: {
    ...
    mbtiType: "ESTJ",
    title: "효율적 관리자",
    description: "당신은 쟝 키르슈타인과 같은 성격입니다. 체계적이고 효율적이며 리더십을 가진 사람입니다.",
    analysis: "쟝처럼 당신은 체계적이고 조직적인 접근을 선호하며, 효율성과 질서를 중시합니다. 리더십이 있고 책임감이 강하며, 목표를 달성하기 위해 계획적으로 행동합니다. 현실적이고 실용적인 사고를 하며, 전통과 규칙을 존중합니다.",
    imageUrl: "/images/jean.jpg",
